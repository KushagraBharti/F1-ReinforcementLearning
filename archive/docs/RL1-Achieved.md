...
```text
assets/gifs/pygame-window-gen49-fastest-89s-all-150-cars-slow.gif
```
...
### `tools\tests\test_learned_policy.py`
...
### `tools\tests\test_gpu_observation.py`
...
`archive\docs\PhysicsV2LearnedPolicyPlan.md` remains the next major simulator-realism direction. V2 must be treated as a new physics model:

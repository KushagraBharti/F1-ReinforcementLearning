...
4. faster iteration through swarm diagnostics and a bounded autonomous campaign loop
...
- swarm diagnostics using many independent same-policy cars
- autonomous staged PPO campaign with benchmark-grounded keep/reject decisions
...
- benchmark seed rotation policy exists for promotion, diagnostics, and holdout checks
- swarm diagnostic mode exists without introducing multi-agent traffic or car-car collision
- autonomous campaign tooling exists with stage-aware waves and machine-readable manifests
